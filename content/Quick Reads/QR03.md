...
aliases:
  ...
  - QR03
draft:
card_icon: /assets/img/quickreads/QR03_1_Pair_Programming.svg
sidebar: false
---
...
> ### Benefits: 
>
>* Reduction in individual [cognitive load](QR01.md) via the collective working memory effect 
...
There are several benefits from pair programming that have been observed through a range of studies. For example, through pair programming, the learners’ **individual [cognitive load](QR01.md)** is reduced, because the tasks to complete are shared between them. This is known as the **collective working memory effect**. Pair programming “separates tasks with low-level demands (typing, computer management and navigation) from tasks with higher cognitive demands (syntax analysis, algorithm development, problem search)”.[^1] However, poor communication between learners can create additional [cognitive load](QR01.md), which could eliminate the benefits of this effect (see ‘Pairing learners’). 
