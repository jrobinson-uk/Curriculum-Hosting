...
aliases:
  ...
  - QR11
draft:
card_icon: /assets/img/quickreads/QR11_1_PRIMM.svg
sidebar: false
---
...
> * Reducing [cognitive load](QR01.md) by unpacking and understanding what program code is doing
...
The PRIMM approach builds and draws on other research in computing education, including Use-Modify-Create[^2], tracing and reading code before writing[^3], the Abstraction Transition Taxonomy,[^4] and the [Block Model](QR12.md)[^5]. The focus on language
...
activities are carried out in pairs, and we already know that [pair programming](QR03.md) is an effective form of learning, and involves learners practising to articulate what to do
