...
aliases:
  ...
  - QR05
draft:
card_icon: /assets/img/quickreads/QR05_1_Live_coding.svg
sidebar: false
---
...
>* Reduces [cognitive load](QR01.md), through collaboration
...
>
>### Strong links with [worked examples](QR02.md):
>Live coding helps novices learn by observing an expert programmer working through a problem, and so it has strong links to the concept of [worked examples](QR02.md). Further information can be found on our Quick Read [](the-cc.io/qr02).
