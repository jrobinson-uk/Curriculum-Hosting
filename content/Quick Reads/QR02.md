...
aliases:
  ...
  - QR02
draft:
card_icon: /assets/img/quickreads/QR02_1_Worked_examples.svg
sidebar: false
---
...
>
>* Help reduce extraneous [cognitive load](QR01.md) on learners
...
Worked examples help reduce the extraneous **[cognitive load](QR01.md)** placed on a learner’s working memory by providing a model solution for a problem, which the learner can read, understand, and adapt to solve similar problems. 
...
When designing worked examples, educators should consider the following features that may affect learners’ [cognitive load](QR01.md) and ability to follow an example.
