...
fileOrder: 17
displayName: Variety in teaching
aliases:
  - Variety
  - Variety in teaching
  - Add variety
  - QR17
draft:
card_icon: /assets/img/quickreads/QR17_1_Variety_in_Teaching.svg
sidebar: false
---
...
Engineering concerns making an artefact that solves a problem or addresses a user need and can link computing to other areas of the curriculum. In computing, an artefact could be a program, system, or digital media. [Physical computing](QR16.md), in particular, is an obvious way to learn about computing through an engineering lens. For example:
...
- Learners develop their inquiry skills when programming with the [PRIMM](QR11.md) methodology; they predict and validate their predictions, as well as investigating and asking questions of the code.
