...
title: Code tracing
fileOrder: 14
displayName: Code Tracing
aliases:
  - QR14
  - code tracing
draft:
card_icon: /assets/img/quickreads/QR14_1_Code_Tracing.svg
sidebar: false
---
...
> - Reduces [cognitive load](QR01.md)
...
Code tracing can contribute to a reduction of the [cognitive load](QR01.md) placed on learners.
...
- The [PRIMM](QR11.md) (Predict, Run, Investigate, Modify, Make)[^5] approach is ideally suited to it as it required learners to Predict in its first step, which involves reading and tracing. - Begin a programming activity or project by providing learners with an existing project or snippet of code. 
